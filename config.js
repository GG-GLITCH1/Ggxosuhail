...
global.location="official gg hackers home,cloud !."
...
global.caption = process.env.CAPTION || global.caption || "official gg !" 


global.devs = "2347041039367" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "234xx";
...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "$üh@îl × gg",
  ownername:process.env.OWNER_NAME|| "official gg",
  ...
  LANG: ( process.env.THEME ||  "official gg"  ).toUpperCase(),
